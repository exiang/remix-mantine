...
function useMantineDefaultProps(component, defaultProps8, props) {
  var _a, _b;
  ...
  return __spreadValues4(__spreadValues4(__spreadValues4({}, defaultProps8), contextProps), filterProps(props));
}
function MantineProvider({
  ...
  const overrides = {
    ...
    defaultProps: inherit ? __spreadValues4(__spreadValues4({}, ctx.defaultProps), defaultProps8) : defaultProps8
  };
...
function createStyles(getCssObjectOrCssObject) {
  ...
  function useStyles8(params, options) {
...
var useStyles3 = createStyles((theme, { spacing, position: position2, noWrap, direction, grow, align, count }) => ({
  root: {
    boxSizing: "border-box",
    display: "flex",
...
var Group_styles_default = useStyles3;
...
var Group = (0, import_react18.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("Group", defaultProps3, props), {
    className,
    position: position2,
    align,
    children,
  ...
  return /* @__PURE__ */ import_react18.default.createElement(Box, __spreadValues14({
...
init_react();
var useStyles4 = createStyles((theme, { color, radius: radius2 }, getRef2) => {
...
var Notification_styles_default = useStyles4;
...
var useStyles5 = createStyles((theme, {
  ...
  return {
    root: __spreadValues15(__spreadProps6(__spreadValues15(__spreadValues15(__spreadValues15({}, theme.fn.fontStyles()), theme.fn.focusStyles()), getLineClamp(lineClamp)), {
...
var Text = (0, import_react19.forwardRef)((props, ref) => {
  ...
  return /* @__PURE__ */ import_react19.default.createElement(Box, __spreadValues16({
    ref,
...
var useStyles6 = createStyles((theme, { color, size: size2, radius: radius2 }) => ({
  root: __spreadProps7(__spreadValues17(__spreadValues17({}, theme.fn.focusStyles()), theme.fn.fontStyles()), {
    position: "relative",
    appearance: "none",
    WebkitAppearance: "none",
    WebkitTapHighlightColor: "transparent",
...
var ActionIcon_styles_default = useStyles6;
...
var ActionIcon = (0, import_react20.forwardRef)((props, ref) => {
  const _a = useMantineDefaultProps("ActionIcon", defaultProps5, props), {
    className,
    color,
    children,
    radius: radius2,
  ...
  const loader = /* @__PURE__ */ import_react20.default.createElement(Loader, __spreadValues18({
    color: colors.color,
    size: theme.fn.size({ size: size2, sizes: sizes3 }) - 12
  }, loaderProps));
  return /* @__PURE__ */ import_react20.default.createElement(Box, __spreadValues18({
    component: component || "button",
...
function CloseIcon(props) {
  return /* @__PURE__ */ import_react21.default.createElement("svg", __spreadValues19({
    viewBox: "0 0 15 15",
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg"
...
var CloseButton = (0, import_react22.forwardRef)((_a, ref) => {
  var _b = _a, { iconSize, size: size2 = "md" } = _b, others = __objRest11(_b, ["iconSize", "size"]);
  const theme = useMantineTheme();
  const _iconSize = iconSize || theme.fn.size({ size: size2, sizes: iconSizes });
  return /* @__PURE__ */ import_react22.default.createElement(ActionIcon, __spreadValues20({
    size: size2,
    ref
...
function useMediaQuery(query, initialValue) {
  const [matches, setMatches] = (0, import_react24.useState)(getInitialValue(query, initialValue));
  const queryRef = (0, import_react24.useRef)();
...
var useIsomorphicEffect = typeof document !== "undefined" ? import_react25.useLayoutEffect : import_react25.useEffect;
...
function useForceUpdate() {
  const [, update] = (0, import_react27.useReducer)(reducer, 0);
  return update;
}
...
function useQueue({ initialValues = [], limit }) {
  const [{ state, queue }, setState] = (0, import_react28.useState)({
...
function Portal(props) {
  const { children, zIndex, target, className, position: position2 } = useMantineDefaultProps("Portal", defaultProps6, props);
  const theme = useMantineTheme();
  ...
  return (0, import_react_dom.createPortal)(/* @__PURE__ */ import_react29.default.createElement("div", {
    className,
    dir: theme.dir,
...
var Transition = /* @__PURE__ */ function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return /* @__PURE__ */ import_react32.default.createElement(TransitionGroupContext_default.Provider, {
      value: null
...
function getChildMapping(children, mapFn) {
  ...
  if (children)
    import_react33.Children.map(children, function(c) {
      return c;
...
var TransitionGroup = /* @__PURE__ */ function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return /* @__PURE__ */ import_react34.default.createElement(TransitionGroupContext_default.Provider, {
      value: contextValue
    }, /* @__PURE__ */ import_react34.default.createElement(Component, props, children));
  };
...
var NotificationsContext = (0, import_react35.createContext)(null);
...
function getNotificationStateStyles({
  ...
  return __spreadValues22(__spreadValues22({}, commonStyles), transitionStyles[state]);
}
...
function NotificationContainer(_a) {
  ...
  const _a2 = notification, { autoClose: notificationAutoClose } = _a2, notificationProps = __objRest13(_a2, ["autoClose"]);
  const autoCloseTimeout = get_auto_close_default(autoClose, notificationAutoClose);
  const hideTimeout = (0, import_react36.useRef)();
  const handleHide = () => {
  ...
  return /* @__PURE__ */ import_react36.default.createElement(Notification, __spreadProps9(__spreadValues23(__spreadValues23({}, notificationProps), others), {
    onClose: handleHide,
...
var NotificationsProvider_styles_default = useStyles7;
...
function useNotificationsState({ limit }) {
  ...
  const showNotification2 = (notification) => {
    ...
    update((notifications) => {
      ...
      return [...notifications, __spreadProps10(__spreadValues24({}, notification), { id })];
    });
    return id;
  };
...
function NotificationsProvider(_a) {
  ...
  const previousLength = (0, import_react37.useRef)(0);
  const {
    notifications,
    queue,
    showNotification: showNotification2,
  ...
  const items = notifications.map((notification) => /* @__PURE__ */ import_react37.default.createElement(Transition_default, {
    key: notification.id,
    timeout: duration,
    onEnter: () => refs.current[notification.id].offsetHeight,
    nodeRef: { current: refs.current[notification.id] }
  }, (state) => /* @__PURE__ */ import_react37.default.createElement(NotificationContainer_default, {
    innerRef: (node2) => {
    ...
    autoClose,
    sx: [
      __spreadValues25({}, get_notification_state_styles_default({
        state,
        positioning,
  ...
  return /* @__PURE__ */ import_react37.default.createElement(NotificationsContext.Provider, {
    value: ctx
  }, /* @__PURE__ */ import_react37.default.createElement(Portal, {
    zIndex
  }, /* @__PURE__ */ import_react37.default.createElement(Box, __spreadValues25({
    className: cx(classes.notifications, className),
    style,
    sx: __spreadValues25({
      maxWidth: containerWidth
    }, get_position_styles_default(positioning, containerWidth, theme.spacing.md))
  }, others), /* @__PURE__ */ import_react37.default.createElement(TransitionGroup_default, null, items))), children);
}
 ...
 */
//# sourceMappingURL=/build/_shared/chunk-5FJAJG3K.js.map
