...
function assignSizeVariables(variables, sizes3, name) {
  Object.keys(sizes3).forEach((size2) => {
    variables[`--mantine-${name}-${size2}`] = typeof sizes3[size2] === "number" ? `${sizes3[size2]}px` : sizes3[size2];
  });
}
...
function mergeTheme(currentTheme, themeOverride) {
  ...
  return Object.keys(currentTheme).reduce((acc, key) => {
    if (key === "headings" && themeOverride.headings) {
      const sizes3 = themeOverride.headings.sizes ? Object.keys(currentTheme.headings.sizes).reduce((headingsAcc, h) => {
...
function useMantineDefaultProps(component, defaultProps3, props) {
  var _a, _b;
...
function MantineProvider({
  ...
  const overrides = {
    ...
    defaultProps: inherit ? __spreadValues4(__spreadValues4({}, ctx.defaultProps), defaultProps3) : defaultProps3
  };
...
function createStyles(getCssObjectOrCssObject) {
  ...
  function useStyles3(params, options) {
...
function Bars(_a) {
  ...
  return /* @__PURE__ */ import_react12.default.createElement("svg", __spreadValues7({
    viewBox: "0 0 135 140",
...
var useStyles = createStyles((theme, {
  ...
  return {
    ...
    input: variant2 === "headless" ? {} : __spreadProps4(__spreadValues11(__spreadProps4(__spreadValues11({}, theme.fn.fontStyles()), {
...
var useStyles2 = createStyles((theme, {
  ...
  return {
    ...
    root: __spreadProps5(__spreadValues12(__spreadValues12(__spreadValues12(__spreadValues12({}, getSizeStyles({ compact, size: size2 })), theme.fn.fontStyles()), theme.fn.focusStyles()), getWidthStyles(fullWidth)), {
      borderRadius: theme.fn.radius(radius2),
      fontWeight: 600,
      position: "relative",
      lineHeight: 1,
...
// app/routes/mantine.jsx
function Mantine() {
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("h1", null, "Mantine"), /* @__PURE__ */ React.createElement("h2", null, "Buttons"), /* @__PURE__ */ React.createElement(Button, null, "Hello world!"), /* @__PURE__ */ React.createElement("h2", null, "Notifications"));
}
export {
  Mantine as default
};
 ...
 */
//# sourceMappingURL=/build/routes/mantine-YLMOCFIJ.js.map
