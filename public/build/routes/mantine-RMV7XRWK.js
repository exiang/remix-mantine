...
function useMantineDefaultProps(component, defaultProps5, props) {
  var _a, _b;
  ...
  return __spreadValues4(__spreadValues4(__spreadValues4({}, defaultProps5), contextProps), filterProps(props));
}
function MantineProvider({
  ...
  const overrides = {
    ...
    defaultProps: inherit ? __spreadValues4(__spreadValues4({}, ctx.defaultProps), defaultProps5) : defaultProps5
  };
...
var Box = (0, import_react11.forwardRef)((_a, ref) => {
  var _b = _a, { className, component, style, sx } = _b, others = __objRest2(_b, ["className", "component", "style", "sx"]);
  const { systemStyles, rest } = extractSystemStyles(others);
  const Element = component || "div";
  return /* @__PURE__ */ import_react11.default.createElement(Element, __spreadValues6({
    ref,
...
function Bars(_a) {
  ...
  return /* @__PURE__ */ import_react12.default.createElement("svg", __spreadValues8({
    viewBox: "0 0 135 140",
    xmlns: "http://www.w3.org/2000/svg",
    fill: color,
    width: `${size2}px`
  }, others), /* @__PURE__ */ import_react12.default.createElement("rect", {
    y: "10",
    width: "15",
    height: "120",
    rx: "6"
  }, /* @__PURE__ */ import_react12.default.createElement("animate", {
...
function Oval(_a) {
  ...
  return /* @__PURE__ */ import_react13.default.createElement("svg", __spreadValues9({
    width: `${size2}px`,
    height: `${size2}px`,
    viewBox: "0 0 38 38",
    xmlns: "http://www.w3.org/2000/svg",
    stroke: color
  }, others), /* @__PURE__ */ import_react13.default.createElement("g", {
    fill: "none",
    fillRule: "evenodd"
...
function Dots(_a) {
  ...
  return /* @__PURE__ */ import_react14.default.createElement("svg", __spreadValues10({
    width: `${size2}px`,
    height: `${size2 / 4}px`,
    viewBox: "0 0 120 30",
    xmlns: "http://www.w3.org/2000/svg",
    fill: color
  }, others), /* @__PURE__ */ import_react14.default.createElement("circle", {
    cx: "15",
    cy: "15",
    r: "15"
  }, /* @__PURE__ */ import_react14.default.createElement("animate", {
    attributeName: "r",
    from: "15",
    to: "15",
    begin: "0s",
...
function Loader(props) {
  ...
  return /* @__PURE__ */ import_react15.default.createElement(Box, __spreadValues11({
    role: "presentation",
...
var ActionIcon = (0, import_react16.forwardRef)((props, ref) => {
  ...
  const loader = /* @__PURE__ */ import_react16.default.createElement(Loader, __spreadValues12({
    color: colors.color,
    size: theme.fn.size({ size: size2, sizes }) - 12
  }, loaderProps));
  return /* @__PURE__ */ import_react16.default.createElement(Box, __spreadValues12({
...
function CloseIcon(props) {
  return /* @__PURE__ */ import_react17.default.createElement("svg", __spreadValues13({
    viewBox: "0 0 15 15",
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg"
...
var CloseButton = (0, import_react18.forwardRef)((_a, ref) => {
  ...
  return /* @__PURE__ */ import_react18.default.createElement(ActionIcon, __spreadValues14({
    size: size2,
    ref
  }, others), /* @__PURE__ */ import_react18.default.createElement(CloseIcon, {
    width: _iconSize,
    height: _iconSize
  }));
});
...
var Button = (0, import_react20.forwardRef)((props, ref) => {
  ...
  const colors = theme.fn.variant({ color, variant: variant2 });
  const loader = /* @__PURE__ */ import_react20.default.createElement(Loader, __spreadValues19({
    color: colors.color,
    size: theme.fn.size({ size: size2, sizes: heights }) / 2
  }, loaderProps));
  return /* @__PURE__ */ import_react20.default.createElement(Box, __spreadValues19({
    component: component || "button",
  ...
  }, others), /* @__PURE__ */ import_react20.default.createElement("div", {
    className: classes.inner
  }, (leftIcon || loading && loaderPosition === "left") && /* @__PURE__ */ import_react20.default.createElement("span", {
    className: cx(classes.icon, classes.leftIcon)
  }, loading && loaderPosition === "left" ? loader : leftIcon), /* @__PURE__ */ import_react20.default.createElement("span", {
    className: classes.label,
    style: { textTransform: uppercase ? "uppercase" : void 0 }
  }, children), (rightIcon || loading && loaderPosition === "right") && /* @__PURE__ */ import_react20.default.createElement("span", {
...
init_react();
var useStyles5 = createStyles((theme, { color, radius: radius2 }, getRef2) => {
...
var Notification_styles_default = useStyles5;
 ...
 */
//# sourceMappingURL=/build/routes/mantine-RMV7XRWK.js.map
